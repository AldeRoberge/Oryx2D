...
public class GuildHallPortalPanel extends Panel {
    ...
    public GuildHallPortalPanel(AGameSprite param1, GuildHallPortal param2) {
        ...
        this.owner = param2;
        if ((this.gs.map == null) || (this.gs.map.player == null)) {
            return;
        }
        ...
        if ((loc3.guildName != null) && (loc3.guildName.length() > 0)) {
            ...
            this.addEventListener(Event.ADDED_TO_STAGE, new EventConsumer<>(this::onAdded));
        } else {
            ...
            this.addChild(this.noGuildText);
        }
    ...
    private void onAdded(Event param1) {
        ...
        this.addEventListener(Event.REMOVED_FROM_STAGE, new EventConsumer<>(this::onRemoved));
    }
    ...
    private void enterPortal() {
        this.gs.gsc.usePortal(this.owner.objectId);
    }
}
