...
public class BitmapParticle extends BasicObject {
    ...
    public void draw(Vector<IGraphicsData> param1, Camera param2, int param3) {
        ...
        try {
            ...
            this.vS.length = 0;
            this.vS.add(this.posS.get(3) - (w / 2), this.posS.get(4) - (h / 2), this.posS.get(3) + (w / 2), this.posS.get(4) - (h / 2), this.posS.get(3) + (w / 2), this.posS.get(4) + (h / 2), this.posS.get(3) - (w / 2), this.posS.get(4) + (h / 2));
