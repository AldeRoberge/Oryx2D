...
public class Point3D {
	...
	private static final Vector<Integer> commands = new Vector<>(GraphicsPathCommand.MOVE_TO, GraphicsPathCommand.LINE_TO, GraphicsPathCommand.LINE_TO, GraphicsPathCommand.LINE_TO);
	...
	public void draw(Vector<IGraphicsData> param1, Vector3D param2, double param3, Matrix3D param4, Camera param5, BitmapData param6) {
		this.draw(param1, param2, param3, param4, param5, param6, 0);
	}
